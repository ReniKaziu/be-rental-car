...
export class second1728148584346 implements MigrationInterface {
    name = 'second1728148584346'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`logs\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` bigint NOT NULL, \`updatedAt\` bigint NOT NULL, \`message\` varchar(10) NOT NULL, \`level\` enum ('error', 'info') NULL, \`userId\` int NULL, \`ipAddress\` varchar(45) NULL, \`stackTrace\` text NULL, \`source\` varchar(255) NULL, \`additionalInfo\` text NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
